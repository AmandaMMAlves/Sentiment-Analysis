...
def load_api():
    ...
    consumer_key = 'w3CgWib6rnUmrwvMnuQyYRy8C'
    consumer_secret = 'HAZbKpq6aPvaQJbBrUOGaoVXpvCil7eqxcRL9ets9x1JPUUOYm'
    access_token = '4079288081-WWf5JKRS5qccROprjCJDYd2gjSHm08TdmHyqdb0'
    access_secret = 'EoaUkFJQf7JNwAoh64v3wH3YsRxT8PtInmj1i5yQ9kAcf'
...
def main():
    ...
    ''' search variables: '''
    search_phrases = ['#StrangeThings','Strange Things', 'Eleven', 'Netflix', 'Dustin', 'Lucas', 'Max', 'Mike', 'Will']
    time_limit = 0.25                           # runtime limit in hours
    max_tweets = 50                             # number of tweets per search (will be
